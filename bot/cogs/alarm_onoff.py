...
kor_table_dic = {"Academic_Information": "학사안내", "Event_Information": "행사안내", "General_News": "일반소식", "ceboard": "컴퓨터공학과 공지사항", "aiboard": "인공지능공학전공 공지사항", "biskit": "비스킷 마일리지", "Hagsigdang": "학식당", "faculty_cafeteria": "교직원식당", "Purum": "푸름관", "Orum1": "오름1관", "Orum23": "오름2,3관", "error": "에러 알림"}
table_list = KumohSquarePage.name_list() + ["biskit", "ceboard", "aiboard", "Hagsigdang", "faculty_cafeteria", "Purum", "Orum1", "Orum23", "error"]
